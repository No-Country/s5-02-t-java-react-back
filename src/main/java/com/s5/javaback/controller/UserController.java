...
public class UserController {
    ...
    @ApiOperation(value ="GetAll", notes="Devuelve todos los usuarios",
    ...
    @ApiOperation(value ="GetById", notes="Busca un usuario por id",
            response = ResponseEntity.class)
    @GetMapping("/{id}")
    ...
    @ApiOperation(value ="Update", notes="Actualiza un usuario",
            response = ResponseEntity.class)
    @PutMapping("/update")
    ...
    @ApiOperation(value ="Borrar", notes="Borra un usuario por id",
            response = ResponseEntity.class)
    @DeleteMapping("/{id}")
